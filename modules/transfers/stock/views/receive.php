                ...
                <li class="list-group-item px-0">
                  <div class="d-flex justify-content-between align-items-start">
                    <div>
                      ...
                      <div class="small text-muted">Product: <?= htmlspecialchars((string)$disc['product_id'], ENT_QUOTES, 'UTF-8') ?> · Qty: <?= (int)$disc['qty_expected'] ?: (int)$disc['qty_actual'] ?: '' ?><?= (int)$disc['qty'] ?? '' ?></div>
